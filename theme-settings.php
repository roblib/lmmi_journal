...
function lmmi_journal_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['#attached']['library'][] = 'lmmi_journal/theme-settings';
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['breadcrumb_separator'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_separator', 'lmmi_journal'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_display'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_display', 'lmmi_journal'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_icon'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_icon','lmmi_journal'),
    '#size'          => 20,
    '#maxlength'     => 100,
  );
  ...
  $form['mtt_settings']['basic_tab']['basic_settings']['scrolltop']['scroll_to_top_region'] = array(
    ...
    '#default_value' => theme_get_setting('scroll_to_top_region', 'lmmi_journal'),
    '#options' => array(
  ...
  $form['mtt_settings']['bootstrap_tab']['bootstrap']['bootstrap_remote_type'] = array(
    ...
    '#description'   => t('From the drop down select box, select how to load the Bootstrap library. If you select "Local" make sure that you download and place Bootstrap folder into the root theme folder (lmmi_journal/bootstrap).'),
    '#default_value' => theme_get_setting('bootstrap_remote_type', 'lmmi_journal'),
    '#options' => array(
  ...
  '#type' => 'item',
   ...
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-01-looknfeel.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['animations_state_ad'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-02-region.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['post_tab']['post']['reading_time_ad'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-03-article.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['layout_tab']['layout_modes']['layout_mode_ad'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-04-layout.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['font_tab']['font']['font_title_ad'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-05-fonts.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['revolution_slider_fullscreen_ad'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-06-slideshow.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['google_maps_tab']['google_maps_key_ad'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . drupal_get_path('theme', 'lmmi_journal') . '/images/premium-09-googlemaps.jpg" />
   </a></div> ',
  );
